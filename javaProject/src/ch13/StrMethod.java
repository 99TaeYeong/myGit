...
public class StrMethod {
	public static void main(String[] args) {
		String str1 = "java";
		str1 += " programming";//str1=str1+"programing",문자열 연결이지만 실제로 새로운
		//문자열을 만들고 str1은 새로운 문자열의 주소값을 가리키게됨
		System.out.println(str1.length());//문자열의 길이
		String str2 =str1.concat(" programming");//concat()도 문자열 연결시킴
		...
		System.out.println(str2.substring(0,4));//substring(start,end-1)=>(0~3) 파이썬 슬라이싱이랑 비슷
